...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent bg-black bg-opacity-55 backdrop-blur-md shadow-input flex justify-center space-x-4 px-8 py-6"
    >
      {children}
    </nav>
  );
